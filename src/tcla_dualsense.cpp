...
static void LoadConfig(HMODULE self) {
    ...
    g_menuBgHeight = (int)GetPrivateProfileIntA("Controller", "MenuBackgroundHeight", 100, path);
    if (g_menuBgHeight < 50) g_menuBgHeight = 50;
    if (g_menuBgHeight > 150) g_menuBgHeight = 150;
